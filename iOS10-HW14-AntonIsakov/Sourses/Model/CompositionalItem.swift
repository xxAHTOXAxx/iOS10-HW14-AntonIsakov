...
extension CompositionalSection {
    ...
    static var modelSectionArray = [
        CompositionalSection(name: "Мои альбомы", items: [CompositionalItem(description: "Недавние", image: UIImage(named: "BMW") ?? UIImage() , numberOfPhotos: 6),
        ...
        CompositionalSection(name: "Люди и места", items: [CompositionalItem(description: "Люди", image: UIImage(named: "moto") ?? UIImage(), numberOfPhotos: 123),
                                                           CompositionalItem(description: "Места", image: UIImage(named: "dog") ?? UIImage(), numberOfPhotos: 123)]),
        
        CompositionalSection(name: "Типы медиафайлов", items: [CompositionalItem(description: "Видео", image: UIImage(systemName: "video") ?? UIImage(), numberOfPhotos: 123),
                                                               ...
                                                               CompositionalItem(description: "Панорамы", image: UIImage(systemName: "checkmark.rectangle.fill") ?? UIImage(), numberOfPhotos: 53),
        ...
        CompositionalSection(name: "Другое", items: [CompositionalItem(description: "Имрортированные", image: UIImage(systemName: "square.and.arrow.down") ?? UIImage(), numberOfPhotos: 123),
